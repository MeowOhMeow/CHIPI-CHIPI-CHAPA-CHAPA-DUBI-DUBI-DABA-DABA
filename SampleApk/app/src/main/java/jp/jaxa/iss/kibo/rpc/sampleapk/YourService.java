...
public class YourService extends KiboRpcService {
    ...
    protected void runPlan1() {
        ...
        //api.moveTo(new Point(10.87d, -9.5d, 4.9d), new Quaternion(-0.5f, 0.5f, 0.5f, 0.5f), false);
        api.moveTo(new Point(10.67d, -9.5d, 4.77d), new Quaternion(-0.5f, 0.5f, 0.5f, 0.5f), false);
