...
public class Debugging_new {
	...
	public static void main(String[] args) {
		...
		try {
			session = env.createSession("./src/main/java/best.onnx");

			// Mat img = Imgcodecs.imread("source
			// folder/45fb2e43-0564-41c0-8fb9-51f92c226a2e.png"); //kapton_tape: 5
			// Mat img = Imgcodecs.imread("source
			// folder/902d1d66-65d9-4069-a2ec-bf8443a07fd0.png"); //pipette: 1
			// Mat img = Imgcodecs.imread("source
			// folder/63651b40-583c-4a42-a474-8bbc51e523f1.png"); //beaker: 1，top: 1
			...
			System.out.println(
					"Dimensions of the new image will be: \n height: " + new_height + "\n width: " + new_width);
			...
			for (int i : ints) {
				...
				System.out.println("box: " + boxes_double.get(i)[0] + ", " + boxes_double.get(i)[1] + ", "
						+ boxes_double.get(i)[2] + ", " + boxes_double.get(i)[3]);
